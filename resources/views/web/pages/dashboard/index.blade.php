                        ...
                        <div class="tabs -active-purple-2 js-tabs pt-0">
                            <div
                                ...
                                <button class="tabs__button text-light-1 js-tabs-button is-active"
                                    data-tab-target=".-tab-item-5" type="button">
                                    Close Account
                                </button>
                            </div>
                            ...
                            <div class="tabs__content py-30 px-30 js-tabs-content">
                                <div class="tabs__pane -tab-item-1">
                                    <div class="row y-gap-20 x-gap-20 items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <div class="text-14 lh-1 mt-10">PNG or JPG no bigger than 800px wide and tall.
                                            </div>
                                ...
                                <div class="tabs__pane -tab-item-4">
                                    <form action="#" class="contact-form">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="text-16 fw-500 text-dark-1">Notifications - Choose when and how
                                                    to be notified</div>
                                                <p class="text-14 lh-13 mt-5">Select push and email notifications you'd
                                                    like to receive</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pt-60">
                                            <div class="row y-gap-20 justify-between">
                                                <div class="col-auto">
                                                    <div class="text-16 fw-500 text-dark-1">Choose when and how to be
                                                        notified</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="border-top-light pt-20 mt-20">
                                                ...
                                                <div class="row y-gap-20 justify-between">
                                                    <div class="col-auto">
                                                        <div class="text-16 fw-500 text-dark-1">Replies to my comments
                                                        </div>
                                                        <p class="text-14 lh-13 mt-5">Notify me about activity from the
                                                            profiles I'm subscribed to</p>
                                                    </div>
                                            ...
                                            <div class="border-top-light pt-20 mt-20">
                                                ...
                                                <div class="row y-gap-20 justify-between">
                                                    <div class="col-auto">
                                                        <div class="text-16 fw-500 text-dark-1">Activity on my comments
                                                        </div>
                                                        <p class="text-14 lh-13 mt-5">Notify me about activity from the
                                                            profiles I'm subscribed to</p>
                                                    </div>
                                        ...
                                        <div class="pt-60">
                                            ...
                                            <div class="pt-30">
                                                ...
                                                <div class="row y-gap-20 justify-between">
                                                    <div class="col-auto">
                                                        <div class="text-16 fw-500 text-dark-1">Send me emails about my
                                                            Cursus activity and updates I requested</div>
                                                        <p class="text-14 lh-13 mt-5">Notify me about activity from the
                                                            profiles I'm subscribed to</p>
                                                    </div>
                                                    <div class="col-auto">
                                ...
                                <div class="tabs__pane -tab-item-5 is-active">
                                    <form action="#" class="contact-form row y-gap-30">
                                        <div class="col-12">
                                            ...
                                            <p class="mt-10">Warning: If you close your account, you will be unsubscribed
