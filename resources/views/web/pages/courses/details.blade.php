                ...
                <div class="page-header__content pt-90 pb-90">
                    <div class="row y-gap-30 relative" style="">
                        ...
                        <div data-scrollmagic-pin-spacer="" class="scrollmagic-pin-spacer"
                          style="inset: 0px 0px auto auto; margin: 0px; display: block; position: absolute; box-sizing: content-box; width: 360px; height: 791.062px;">
                            <div class="courses-single-info js-pin-content"
                              style="position: absolute; margin: auto; inset: 0px auto auto 0px;">
                                <div class="bg-white shadow-2 rounded-8 border-light py-10 px-10">
                                    ...
                                    <div class="courses-single-info__content scroll-bar-1 pt-30 pb-20 px-20">
                                        ...
                                        <a href="{{route('courses.add', $course->id)}}"
