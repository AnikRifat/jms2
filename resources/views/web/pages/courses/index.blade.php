                            ...
                            <div class="tabs__pane -tab-item-1 is-active">
                                ...
                                <div class="row y-gap-30 pt-30">
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/1.png" alt="image">
                                        ...
                                        <div class="pt-15">
                                            ...
                                            <h3 class="text-16 fw-500 lh-15 mt-10">Learn Figma - UI/UX Design Essential
                                                Training</h3>
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/2.png" alt="image">

                                            <button class="absolute-button" data-el-toggle=".js-more-2-toggle">
                                                <span
                                                  class="d-flex items-center justify-center size-35 bg-white shadow-1 rounded-8">
                                                    <i class="icon-menu-vertical"></i>
                                                </span>
                                            ...
                                            <div class="toggle-element -dshb-more js-more-2-toggle">
                                                <div
                                                  class="px-25 py-25 bg-white -dark-bg-dark-2 shadow-1 border-light rounded-8">
                                                    <a href="#" class="d-flex items-center">
                                                        <div class="icon-share"></div>
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/3.png" alt="image">

                                            <button class="absolute-button" data-el-toggle=".js-more-3-toggle">
                                                <span
                                                  class="d-flex items-center justify-center size-35 bg-white shadow-1 rounded-8">
                                                    <i class="icon-menu-vertical"></i>
                                                </span>
                                            ...
                                            <div class="toggle-element -dshb-more js-more-3-toggle">
                                                <div
                                                  class="px-25 py-25 bg-white -dark-bg-dark-2 shadow-1 border-light rounded-8">
                                                    <a href="#" class="d-flex items-center">
                                                        <div class="icon-share"></div>
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/4.png" alt="image">

                                            <button class="absolute-button" data-el-toggle=".js-more-4-toggle">
                                                <span
                                                  class="d-flex items-center justify-center size-35 bg-white shadow-1 rounded-8">
                                                    <i class="icon-menu-vertical"></i>
                                                </span>
                                            ...
                                            <div class="toggle-element -dshb-more js-more-4-toggle">
                                                <div
                                                  class="px-25 py-25 bg-white -dark-bg-dark-2 shadow-1 border-light rounded-8">
                                                    <a href="#" class="d-flex items-center">
                                                        <div class="icon-share"></div>
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/5.png" alt="image">

                                            <button class="absolute-button" data-el-toggle=".js-more-5-toggle">
                                                <span
                                                  class="d-flex items-center justify-center size-35 bg-white shadow-1 rounded-8">
                                                    <i class="icon-menu-vertical"></i>
                                                </span>
                                            ...
                                            <div class="toggle-element -dshb-more js-more-5-toggle">
                                                <div
                                                  class="px-25 py-25 bg-white -dark-bg-dark-2 shadow-1 border-light rounded-8">
                                                    <a href="#" class="d-flex items-center">
                                                        <div class="icon-share"></div>
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/6.png" alt="image">

                                            <button class="absolute-button" data-el-toggle=".js-more-6-toggle">
                                                <span
                                                  class="d-flex items-center justify-center size-35 bg-white shadow-1 rounded-8">
                                                    <i class="icon-menu-vertical"></i>
                                                </span>
                                            ...
                                            <div class="toggle-element -dshb-more js-more-6-toggle">
                                                <div
                                                  class="px-25 py-25 bg-white -dark-bg-dark-2 shadow-1 border-light rounded-8">
                                                    <a href="#" class="d-flex items-center">
                                                        <div class="icon-share"></div>
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/7.png" alt="image">

                                            <button class="absolute-button" data-el-toggle=".js-more-7-toggle">
                                                <span
                                                  class="d-flex items-center justify-center size-35 bg-white shadow-1 rounded-8">
                                                    <i class="icon-menu-vertical"></i>
                                                </span>
                                            ...
                                            <div class="toggle-element -dshb-more js-more-7-toggle">
                                                <div
                                                  class="px-25 py-25 bg-white -dark-bg-dark-2 shadow-1 border-light rounded-8">
                                                    <a href="#" class="d-flex items-center">
                                                        <div class="icon-share"></div>
                                    ...
                                    <div class="w-1/5 xl:w-1/3 lg:w-1/2 sm:w-1/1">
                                        <div class="relative">
                                            <img class="rounded-8 w-1/1" src="img/coursesCards/8.png" alt="image">

                                            <button class="absolute-button" data-el-toggle=".js-more-8-toggle">
                                                <span
                                                  class="d-flex items-center justify-center size-35 bg-white shadow-1 rounded-8">
                                                    <i class="icon-menu-vertical"></i>
                                                </span>
                                            ...
                                            <div class="toggle-element -dshb-more js-more-8-toggle">
                                                <div
                                                  class="px-25 py-25 bg-white -dark-bg-dark-2 shadow-1 border-light rounded-8">
                                                    <a href="#" class="d-flex items-center">
                                                        <div class="icon-share"></div>
